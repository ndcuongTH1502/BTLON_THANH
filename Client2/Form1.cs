    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //Bắt đầu gửi
                cA.BeginSend(guiText, 0, guiText.Length, SocketFlags.None, new AsyncCallback(SendData), cA);
        ...
        void nhanDuLieu()
        {
            while (true)
            {
                ...
                {
                    cA.BeginReceive(data, 0, data.Length, SocketFlags.None, new AsyncCallback(ReceiveData), cA);
                }
            }
        }
